...
const Footer = () => {
  return (
    <div className="">
      <footer className="p-12 grid lg:grid-cols-3 md:grid-cols-2 lg:gap-20 gap-6 mt-20 justify-between  bg-[#0000ced7] text-white">
      ...
      <div className="bg-[#0e0ef4d7] text-white px-12 flex justify-between items-center py-4">
